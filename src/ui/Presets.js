export class Presets {
    ...
    constructor(container, options = {}) {
        ...
        this.onUpdate = options.onUpdate || ((presets) => {
    ...
    setupEventListeners() {
        ...
        document.addEventListener('click', (event) => {
            ...
            if (event.target.classList.contains('preset-button') && !event.target.classList.contains('preset-empty')) {
                this.handleButtonClick(event);
            } else if (event.target.closest('.preset-button') && !event.target.classList.contains('preset-delete-button')) {
